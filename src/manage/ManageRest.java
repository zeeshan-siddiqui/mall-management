 ...
 * @author Zeeshan
 */
public class ManageRest extends javax.swing.JFrame {
    public ManageRest() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        
        DefaultTableModel model= (DefaultTableModel) rstData.getModel();
        rstData.setModel(model);
        rstData.setRowHeight(140);
        
        rstData.getColumn("Logo").setCellRenderer(new myTableCellRenderer());
        rstData.getColumn("Image").setCellRenderer(new myTableCellRenderer());
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment( JLabel.CENTER );
        rstData.getColumnModel().getColumn(0).setCellRenderer( centerRenderer );
        rstData.getColumnModel().getColumn(1).setCellRenderer( centerRenderer );
        rstData.getColumnModel().getColumn(2).setCellRenderer( centerRenderer );
        rstData.getColumnModel().getColumn(3).setCellRenderer( centerRenderer );
        
        rstData.getTableHeader().setFont(new Font("Times new Roman",Font.BOLD,48));
    }
    ...
    private void initComponents() {
        ...
        rstData = new javax.swing.JTable();
        ...
        jLabel2.setText("manage restaurants details");
        jPanel4.add(jLabel2);
        jLabel2.setBounds(175, 8, 610, 44);
        ...
        rstData.setFont(new java.awt.Font("Calibri", 1, 22)); // NOI18N
        rstData.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Restaurant Name", "Description", "Floor", "Timing", "Logo", "Image"
            }
        ) {
        ...
        rstData.getTableHeader().setReorderingAllowed(false);
        rstData.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                rstDataMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(rstData);
        ...
        jButton5.setText("Add New Restaurants");
        ...
        jButton5.setBounds(380, 10, 230, 30);
        ...
        rstname.setFont(new java.awt.Font("Tahoma", 1, 19)); // NOI18N
        rstname.setPreferredSize(new java.awt.Dimension(240, 32));
        jPanel5.add(rstname);
        rstname.setBounds(506, 410, 240, 32);
        ...
        if(validateFields())
        {
            try
            {
                ...
                if(code==JOptionPane.YES_OPTION)
                {
                    ...
                    String sql="Delete From Restaurants where RESTAURANT_NAME ='"+rst+"' ";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Connection con =MyConnection.getConnection();
            PreparedStatement ps=con.prepareStatement("select * from Restaurants order by Restaurant_name");
            ResultSet rs=ps.executeQuery();

            while(rs.next())
            {
                String rstName = rs.getString("Restaurant_Name");
                ...
                Image logoIc=icon1.getImage().getScaledInstance(160, 140, Image.SCALE_SMOOTH);
                
                ImageIcon icon2=new ImageIcon(imgImg);
                Image imgIc=icon2.getImage().getScaledInstance(160, 140, Image.SCALE_SMOOTH);
                ...
                //System.out.println(rstName + "|" + desc );
                model.addRow(new Object[] {rstName, desc, floor, time, logolabel, imglabel});
            }
        }
        catch(Exception e)
        {
    ...
    private void rstDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rstDataMouseClicked
        int index = rstData.getSelectedRow();
        DefaultTableModel model=(DefaultTableModel)rstData.getModel();
        
        String stname = model.getValueAt(index, 0).toString();
        rstname.setText(stname);
    }//GEN-LAST:event_rstDataMouseClicked
    ...
    public static void main(String args[]) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageRest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageRest().setVisible(true);
            }
        });
    }
    ...
    private boolean validateFields()
     {
        ...
        {
            JOptionPane.showMessageDialog(ManageRest.this, "Enter REstaurant Name");
            rstname.grabFocus();
            return false;
        }
    ...
    private javax.swing.JTable rstData;
