 ...
 * @author Zeeshan
 */
public class KeeperLogin extends javax.swing.JFrame {

    /**
     * Creates new form KeeperLogin
     */
    public KeeperLogin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Shopkeeper");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(50, 280, 240, 60);
        ...
        jPanel3.add(jLabel7);
        jLabel7.setBounds(60, 320, 210, 19);
        ...
        jButton1.setBounds(40, 270, 250, 30);
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(360, 20, 330, 400);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String sql="select password from keepsign where username='"+juser.getText()+"'";
    ...
    public static void main(String args[]) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KeeperLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KeeperLogin().setVisible(true);
            }
        });
    }
