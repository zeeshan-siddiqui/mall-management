 ...
 * @author Zeeshan
 */
public class AddStr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.add(jLabel4);
        jLabel4.setBounds(38, 32, 118, 30);

        jLabel10.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel10.setText("Timing");
        jPanel6.add(jLabel10);
        jLabel10.setBounds(40, 190, 115, 30);

        jLabel11.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel11.setText("Store Image");
        jPanel6.add(jLabel11);
        jLabel11.setBounds(40, 310, 119, 30);

        jLabel12.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel12.setText("Store Logo");
        jPanel6.add(jLabel12);
        jLabel12.setBounds(40, 250, 105, 30);

        time.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(time);
        time.setBounds(196, 200, 222, 28);

        stname.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(stname);
        stname.setBounds(196, 32, 222, 28);
        ...
        jButton2.setBounds(196, 310, 130, 40);
        ...
        jButton3.setBounds(196, 250, 130, 40);
        ...
        jButton4.setBounds(370, 380, 117, 31);
        ...
        jButton5.setBounds(196, 380, 117, 31);

        ipath.setText("No file Choosen");
        jPanel6.add(ipath);
        ipath.setBounds(350, 320, 190, 23);

        lpath.setText("No file choosen");
        jPanel6.add(lpath);
        lpath.setBounds(350, 260, 190, 23);

        jLabel13.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel13.setText("Description");
        jPanel6.add(jLabel13);
        jLabel13.setBounds(38, 91, 115, 30);

        jLabel14.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel14.setText("Floor");
        jPanel6.add(jLabel14);
        jLabel14.setBounds(40, 140, 70, 30);

        desc.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(desc);
        desc.setBounds(196, 91, 222, 28);

        floor.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(floor);
        floor.setBounds(196, 150, 222, 28);

        jPanel5.add(jPanel6);
        jPanel6.setBounds(60, 20, 570, 440);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/manage/storepicm1.jpg"))); // NOI18N
        jPanel5.add(jLabel3);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            ...
            ps.setString(4,ti);
               ...
               {
                    Logger.getLogger(AddStr.class.getName()).log(Level.SEVERE, null, ex);
               }
            if(ps.executeUpdate()>0)
            { 
                ManageSUI mgs=new ManageSUI();
                mgs.setVisible(true);
                mgs.pack();
                mgs.setLocationRelativeTo(null);
                mgs.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                this.setVisible(false);
                JOptionPane.showMessageDialog(this,"Store Succcessfully Added");
            }
        }
    ...
    public static void main(String args[]) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStr().setVisible(true);
            }
        });
    }
    private boolean validateFields()
    {
        if(stname.getText().trim().isEmpty())
        {
            JOptionPane.showMessageDialog(AddStr.this, "Enter Store Name");
            stname.grabFocus();
            return false;
        }
        if(time.getText().trim().isEmpty())
        {
            JOptionPane.showMessageDialog(AddStr.this, "Enter Description");
            time.grabFocus();
            return false;
        }
        return true;
